...
if("TRUE" STREQUAL "TRUE")
  set(vicon_stream_SOURCE_PREFIX /home/thiago/ws/src/vicon_stream)
  set(vicon_stream_DEVEL_PREFIX /home/thiago/ws/devel)
  ...
  set(vicon_stream_INSTALL_PREFIX /home/thiago/ws/install)
...
if(NOT "/usr/include/pcl-1.7;/usr/include/eigen3;/usr/include;/usr/include/ni;/usr/include/vtk-6.2;/usr/include/x86_64-linux-gnu;/usr/include/freetype2;/usr/include/x86_64-linux-gnu/freetype2;/usr/include/jsoncpp;/usr/include/hdf5/openmpi;/usr/lib/openmpi/include/openmpi/opal/mca/event/libevent2021/libevent;/usr/lib/openmpi/include/openmpi/opal/mca/event/libevent2021/libevent/include;/usr/lib/openmpi/include;/usr/lib/openmpi/include/openmpi;/usr/include/python2.7;/usr/include/libxml2;/usr/include/tcl " STREQUAL " ")
  set(vicon_stream_INCLUDE_DIRS "")
  set(_include_dirs "/usr/include/pcl-1.7;/usr/include/eigen3;/usr/include;/usr/include/ni;/usr/include/vtk-6.2;/usr/include/x86_64-linux-gnu;/usr/include/freetype2;/usr/include/x86_64-linux-gnu/freetype2;/usr/include/jsoncpp;/usr/include/hdf5/openmpi;/usr/lib/openmpi/include/openmpi/opal/mca/event/libevent2021/libevent;/usr/lib/openmpi/include/openmpi/opal/mca/event/libevent2021/libevent/include;/usr/lib/openmpi/include;/usr/lib/openmpi/include/openmpi;/usr/include/python2.7;/usr/include/libxml2;/usr/include/tcl")
  if(NOT " " STREQUAL " ")
    set(_report "Check the issue tracker '' and consider creating a ticket if the problem has not been reported yet.")
  elseif(NOT " " STREQUAL " ")
    set(_report "Check the website '' for information and consider reporting the problem.")
  else()
    set(_report "Report the problem to the maintainer 'arun <lakshma2@illinois.edu>' and request to fix the problem.")
  endif()
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      if(NOT IS_DIRECTORY ${include})
        message(FATAL_ERROR "Project 'vicon_stream' specifies '${idir}' as an include dir, which is not found.  It does not exist in '${include}'.  ${_report}")
      endif()
    else()
      message(FATAL_ERROR "Project 'vicon_stream' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/thiago/ws/src/vicon_stream/${idir}'.  ${_report}")
    endif()
...
set(vicon_stream_EXPORTED_TARGETS "")
...
set(depends "roscpp;geometry_msgs;std_msgs;tf2;libmotioncapture")
foreach(depend ${depends})
  ...
  if(${count} EQUAL 1)
    ...
    if(NOT ${vicon_stream_dep}_FOUND)
      find_package(${vicon_stream_dep} REQUIRED NO_MODULE)
    endif()
  else()
    # dependencies with components must be find_package()-ed again
    list(REMOVE_AT depend_list 0)
    find_package(${vicon_stream_dep} REQUIRED NO_MODULE ${depend_list})
  endif()
